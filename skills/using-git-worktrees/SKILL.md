...
metadata:
  hermes:
    tags: [superpowers, git, worktree, isolation, workflow]
...
Hermes does not have a native `EnterWorktree` tool. Use git worktree commands directly via `terminal`.
