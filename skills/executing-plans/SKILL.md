...
metadata:
  hermes:
    tags: [superpowers, execution, implementation, workflow]
    homepage: https://github.com/obra/superpowers
    related_skills: [writing-plans, finishing-a-development-branch, test-driven-development]
---
...
For each task:
1. Mark as in_progress in `todo` tool
2. Follow each step exactly (plan has bite-sized steps)
3. Run verifications as specified
4. Mark as completed in `todo` tool
